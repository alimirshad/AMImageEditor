...
extension CropRectView {
    fileprivate func rectForTopEdgeView(_ rect: inout CGRect, _ resizeControl: ResizeControl) {
    ...
    fileprivate func rectForLeftEdgeView(_ rect: inout CGRect, _ resizeControl: ResizeControl) {
    ...
    fileprivate func rectForBottomEdgeView(_ rect: inout CGRect, _ resizeControl: ResizeControl) {
        rect = CGRect(x: initialRect.minX,
                      y: initialRect.minY,
                      width: initialRect.width,
                      height: initialRect.height + resizeControl.translation.y)
    ...
    fileprivate func rectForRightEdgeView(_ rect: inout CGRect, _ resizeControl: ResizeControl) {
        rect = CGRect(x: initialRect.minX,
                      y: initialRect.minY,
                      width: initialRect.width + resizeControl.translation.x,
                      height: initialRect.height)
    ...
    fileprivate func rectForTopLeftCornerView(_ rect: inout CGRect, _ resizeControl: ResizeControl) {
        rect = CGRect(x: initialRect.minX + resizeControl.translation.x,
                      y: initialRect.minY + resizeControl.translation.y,
                      width: initialRect.width - resizeControl.translation.x,
                      height: initialRect.height - resizeControl.translation.y)
    ...
    fileprivate func rectForTopRightCornerView(_ rect: inout CGRect, _ resizeControl: ResizeControl) {
        rect = CGRect(x: initialRect.minX,
                      y: initialRect.minY + resizeControl.translation.y,
                      width: initialRect.width + resizeControl.translation.x,
                      height: initialRect.height - resizeControl.translation.y)
    ...
    fileprivate func rectForBottomLeftCornerView(_ rect: inout CGRect, _ resizeControl: ResizeControl) {
        rect = CGRect(x: initialRect.minX + resizeControl.translation.x,
                      y: initialRect.minY,
                      width: initialRect.width - resizeControl.translation.x,
                      height: initialRect.height + resizeControl.translation.y)
    ...
    fileprivate func rectForBottomRightCornerView(_ rect: inout CGRect, _ resizeControl: ResizeControl) {
        rect = CGRect(x: initialRect.minX,
                      y: initialRect.minY,
                      width: initialRect.width + resizeControl.translation.x,
                      height: initialRect.height + resizeControl.translation.y)
    ...
    fileprivate func cropRectWithResizeControlView(_ resizeControl: ResizeControl) -> CGRect {
        ...
        if resizeControl == topEdgeView {
            rectForTopEdgeView(&rect, resizeControl)
        } else if resizeControl == leftEdgeView {
            rectForLeftEdgeView(&rect, resizeControl)
        } else if resizeControl == bottomEdgeView {
            rectForBottomEdgeView(&rect, resizeControl)
        } else if resizeControl == rightEdgeView {
            rectForRightEdgeView(&rect, resizeControl)
        } else if resizeControl == topLeftCornerView {
            rectForTopLeftCornerView(&rect, resizeControl)
        } else if resizeControl == topRightCornerView {
            rectForTopRightCornerView(&rect, resizeControl)
        } else if resizeControl == bottomLeftCornerView {
            rectForBottomLeftCornerView(&rect, resizeControl)
        } else if resizeControl == bottomRightCornerView {
            rectForBottomRightCornerView(&rect, resizeControl)
        }
