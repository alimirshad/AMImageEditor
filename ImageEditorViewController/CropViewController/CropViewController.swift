...
//  AMImageEditor
//
//  Created by Ali M Irshad on 03/04/20.
...
open class CropViewController: UIViewController {
    ...
    open override func viewDidLoad() {
        ...
        if self.toolbarItems == nil {
            ...
            let constrainButton = UIBarButtonItem(title: "Constraint", style: .plain, target: self, action: #selector(CropViewController.constrain(_:)))
